...
class BollingerBandADXRSIStrategy(Strategybase):
    ...
    @staticmethod
    def calculate_indicators(historical_data, rolling_window=7)->pd.DataFrame:
    ...
    def extract_latest_indicators(self, historical_data: pd.DataFrame, rolling_window=7) -> tuple:
    ...
    def generate_signals(self,historical_data: pd.DataFrame, rolling_window=7)-> int:
